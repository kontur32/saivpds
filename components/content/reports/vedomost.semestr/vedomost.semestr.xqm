        ...
        <tbody>
         {  
          ...
          <tr>
            ...
            <th class = "text-center">{
              round( avg( $студенты[ средняяОценка/number() > 0 ]/средняяОценка ), 2 ) 
            }</th>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          {
            ...
            return
              <tr class = "text-center">
                ...
                <td>{ round( avg( $i/студенты/студент[ средняяОценка/number() > 0 ]/средняяОценка ), 2 ) }</td>
              </tr>
          }
          <tr>
            ...
            <th class = "text-center">{
              round(
                avg( $семестры/студенты/студент[ средняяОценка/number() > 0 ]/средняяОценка ), 2
             )
            }</th>
          </tr>
        </tbody>
